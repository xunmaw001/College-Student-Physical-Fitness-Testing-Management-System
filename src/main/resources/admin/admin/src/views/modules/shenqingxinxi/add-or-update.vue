<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否申请" prop="shifoushenqing">
          <el-select :disabled="ro.shifoushenqing" v-model="ruleForm.shifoushenqing" placeholder="请选择是否申请">
            <el-option
                v-for="(item,index) in shifoushenqingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否申请" prop="shifoushenqing">
	      <el-input v-model="ruleForm.shifoushenqing"
                placeholder="是否申请" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.banji = true;
          ...
          if(o=='shifoushenqing'){
            this.ruleForm.shifoushenqing = obj[o];
	    this.ro.shifoushenqing = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.banji!=''&&json.banji){
          ...
          this.$message.error(data.msg);
            ...
            this.shifoushenqingOptions = "是,否".split(',')
            this.$http({
	...
	this.ruleForm.shenqingyuanyin = this.ruleForm.shenqingyuanyin.replace(reg,'../../../springboot415ef/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
