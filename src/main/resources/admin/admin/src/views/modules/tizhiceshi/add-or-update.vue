<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="测试编号" prop="ceshibianhao">
            <el-input v-model="ruleForm.ceshibianhao" 
                placeholder="测试编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.ceshibianhao" label="测试编号" prop="ceshibianhao">
              <el-input v-model="ruleForm.ceshibianhao" 
                placeholder="测试编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.ceshiwenjian" label="测试文件" prop="ceshiwenjian">
          <file-upload
          tip="点击上传测试文件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.ceshiwenjian?ruleForm.ceshiwenjian:''"
          @change="ceshiwenjianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.ceshiwenjian" label="测试文件" prop="ceshiwenjian">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.ceshiwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="测试说明" prop="ceshishuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="测试说明"
                  v-model="ruleForm.ceshishuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.ceshishuoming" label="测试说明" prop="ceshishuoming">
                    <span>{{ruleForm.ceshishuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="测试内容" prop="ceshineirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.ceshineirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.ceshineirong" label="测试内容" prop="ceshineirong">
                    <span v-html="ruleForm.ceshineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='ceshibianhao'){
            this.ruleForm.ceshibianhao = obj[o];
	    this.ro.ceshibianhao = true;
            continue;
          }
          if(o=='ceshimingcheng'){
	    ...
	    this.ro.ceshimingcheng = true;
          ...
          if(o=='ceshiwenjian'){
            this.ruleForm.ceshiwenjian = obj[o];
	    this.ro.ceshiwenjian = true;
            continue;
          }
          if(o=='tupian'){
	    ...
	    this.ro.faburiqi = true;
          ...
          if(o=='ceshishuoming'){
            this.ruleForm.ceshishuoming = obj[o];
	    this.ro.ceshishuoming = true;
            continue;
          }
          if(o=='ceshineirong'){
            this.ruleForm.ceshineirong = obj[o];
	    this.ro.ceshineirong = true;
            continue;
          }
          if(o=='jiaoshigonghao'){
	...
	this.ruleForm.ceshineirong = this.ruleForm.ceshineirong.replace(reg,'../../../springboot415ef/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.ceshiwenjian!=null) {
		this.ruleForm.ceshiwenjian = this.ruleForm.ceshiwenjian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    ceshiwenjianUploadChange(fileUrls) {
	this.ruleForm.ceshiwenjian = fileUrls;
	this.addEditUploadStyleChange()
    },
