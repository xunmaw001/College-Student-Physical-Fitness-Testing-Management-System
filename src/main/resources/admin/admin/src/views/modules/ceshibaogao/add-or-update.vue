<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.baogaowenjian" label="报告文件" prop="baogaowenjian">
          <file-upload
          tip="点击上传报告文件"
          action="file/upload"
          :limit="1"
...
export default {
  ...
  methods: {
	...
	this.ruleForm.beizhu = this.ruleForm.beizhu.replace(reg,'../../../springboot415ef/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.baogaowenjian!=null) {
		this.ruleForm.baogaowenjian = this.ruleForm.baogaowenjian.replace(new RegExp(this.$base.url,"g"),"");
	}
