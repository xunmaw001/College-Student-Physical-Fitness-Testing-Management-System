<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="测试编号" prop="ceshibianhao">
          <el-input v-model="ruleForm.ceshibianhao" 
              placeholder="测试编号" clearable  :readonly="ro.ceshibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="测试编号" prop="ceshibianhao">
              <el-input v-model="ruleForm.ceshibianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="测试评分" prop="ceshipingfen">
          <el-input v-model="ruleForm.ceshipingfen" 
              placeholder="测试评分" clearable  :readonly="ro.ceshipingfen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="测试评分" prop="ceshipingfen">
              <el-input v-model="ruleForm.ceshipingfen" 
                placeholder="测试评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="测试评级" prop="ceshipingji">
          <el-select :disabled="ro.ceshipingji" v-model="ruleForm.ceshipingji" placeholder="请选择测试评级">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="测试评级" prop="ceshipingji">
	      <el-input v-model="ruleForm.ceshipingji"
                placeholder="测试评级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="测试评价" prop="ceshipingjia">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.ceshipingjia" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.ceshipingjia" label="测试评价" prop="ceshipingjia">
                    <span v-html="ruleForm.ceshipingjia"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaoshixingming = true;
          ...
          if(o=='ceshipingfen'){
            this.ruleForm.ceshipingfen = obj[o];
	    this.ro.ceshipingfen = true;
            continue;
          }
          if(o=='ceshipingji'){
            this.ruleForm.ceshipingji = obj[o];
	    this.ro.ceshipingji = true;
            continue;
          }
          if(o=='pingfenshijian'){
	    ...
	    this.ro.banji = true;
          ...
          if(o=='ceshipingjia'){
            this.ruleForm.ceshipingjia = obj[o];
	    this.ro.ceshipingjia = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.ceshipingjia = this.ruleForm.ceshipingjia.replace(reg,'../../../springboot415ef/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `ceshichengji/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
