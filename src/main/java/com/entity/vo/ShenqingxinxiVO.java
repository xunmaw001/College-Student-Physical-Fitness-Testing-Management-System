...
public class ShenqingxinxiVO  implements Serializable {
	...
	public void setShifoushenqing(String shifoushenqing) {
		this.shifoushenqing = shifoushenqing;
	}
	
	/**
	 * 获取：是否申请
	 */
	public String getShifoushenqing() {
		return shifoushenqing;
	}
