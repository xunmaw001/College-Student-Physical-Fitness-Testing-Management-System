...
public class ShenqingxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,ShenqingxinxiEntity shenqingxinxi,
		...
		if(tableName.equals("yonghu")) {
			shenqingxinxi.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("jiaoshi")) {
			shenqingxinxi.setJiaoshigonghao((String)request.getSession().getAttribute("username"));
		}
