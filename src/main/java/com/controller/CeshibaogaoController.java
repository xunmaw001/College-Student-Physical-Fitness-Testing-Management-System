...
public class CeshibaogaoController {
    ...
    public R page(@RequestParam Map<String, Object> params,CeshibaogaoEntity ceshibaogao,
		...
		if(tableName.equals("jiaoshi")) {
			ceshibaogao.setJiaoshigonghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			ceshibaogao.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
